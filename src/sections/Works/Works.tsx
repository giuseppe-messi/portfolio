      ...
      <div className={styles.contentBox}>
        ...
        <ul>
          <li>
            ...
            typed, accessible React components, built with scalability, theming,
            and testing in mind.
          </li>
          <br />
          <li>
        ...
        <p>
          ...
          provides a full breakdown of its structure, the technology stack, and
          where to find each feature or example. You can explore the directory
          layout and jump straight into the specific areas you’re interested in.
        </p>
        <br />
        ...
        <ul>
          <li>
            <strong>Auth-Guarded Docs &amp; SSR</strong>: authentication flows,
            protected routes, and SSR/SSG patterns.
          </li>
          <li>
            <strong>State &amp; API Playground</strong>: state management with
            optimistic updates, API fetching, and testing strategies.
          </li>
          <li>
          ...
          <li>
            <strong>Cross-Platform UI</strong>: shared component styling across
            web and native using React Native Web.
          </li>
        </ul>
        <br />
        <p>
